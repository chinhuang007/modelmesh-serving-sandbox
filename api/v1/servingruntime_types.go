...
// +kubebuilder:validation:Enum=triton;mlserver;mleap
...
const (
	...
	// Model server is MLeap
	MLeap ServerType = "mleap"
)

type BuiltInAdapter struct {
	// ServerType can be one of triton/mlserver/mleap and the runtime's container must have the same name
